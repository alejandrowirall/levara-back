...
public class GetRMaintenanceChargeByGridQueryResponse
{
    public GetRMaintenanceChargeByGridQueryResponse(RecurringCharge recurringCharge)
    {
        ...
        FrequencyDescription = recurringCharge.Frequency.HasValue
            ...
            : string.Empty;
        ChargeDescription = recurringCharge.MaintenanceType!.Name;
