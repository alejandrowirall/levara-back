...
public class GetRLeaseChargeByGridQueryResponse
{
    public GetRLeaseChargeByGridQueryResponse(RecurringCharge recurringCharge)
    {
        ...
        FrequencyDescription = recurringCharge.Frequency.HasValue
            ...
            : string.Empty;
        ChargeDescription = recurringCharge.LeaseChargeType!.Name;
